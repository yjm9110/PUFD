...
public class RSM {
   public static final int alpha11 = 3;
       ...
       public Ciphertext ERRR1 = new Ciphertext();
       public Ciphertext ERRR2 = new Ciphertext();
       
       public Ciphertext D1 = new Ciphertext();
       public Ciphertext D2 = new Ciphertext();
       public Ciphertext D3 = new Ciphertext();
       public Ciphertext S1 = new Ciphertext();
       public Ciphertext S2 = new Ciphertext();
    ...
    paillier=_paillier;
          ...
          public void StepOne (){
           ...
           ERRR1=paillier.Encryption( RRR1);
           ERRR2=paillier.Encryption( RRR2);
           ...
           Em3.T1 = ERRR1.T1.modPow(a1, paillier.nsquare); // E(R_1)^{N-1}
           Em3.T2 = ERRR1.T2.modPow(a1, paillier.nsquare);
           Em4.T1 = ERRR2.T1.modPow(a1, paillier.nsquare);// E(R_2)^{N-1}
           Em4.T2 = ERRR2.T2.modPow(a1, paillier.nsquare);         
           ...
           D1.T1=a.T1.multiply(ERR1.T1);// E(x - r_1)
           D1.T2=a.T2.multiply(ERR1.T2);
           D2.T1=b.T1.multiply(ERR2.T1);
           D2.T2=b.T2.multiply(ERR2.T2);//E(y - r_2)
         ...
         //  D11 = paillier.WPDecryption1(D1);
           ...
           CCC = CCC + D1.T1.bitLength() + D1.T2.bitLength()+  D2.T2.bitLength()+  D2.T1.bitLength()+ S1.T1.bitLength() +S1.T2.bitLength()+ S2.T1.bitLength()+ S2.T2.bitLength();
        ...
        public void StepTwo1 (){
            ...
            m11=paillier.PSDecryption1(D1);
            m12=paillier.PSDecryption1(D2); 
            m13=paillier.PSDecryption1(S1); 
            m14=paillier.PSDecryption1(S2);
