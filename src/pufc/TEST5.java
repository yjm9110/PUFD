           ...
           public static void Testnew()
{
   ...
   //        BigInteger      v1= BigInteger.valueOf(1);
     //      BigInteger      v2= BigInteger.valueOf(1);
               ...
               BigInteger CCCC2 =  BigInteger.ZERO ;
                                  ...
                                  for (int jjjj=0; jjjj< N; jjjj++)
                 {
                   ...
                   BigInteger    RR2 = new BigInteger(3,  new Random());
                    PQUERYT[jjjj] = RR2;
                  QUERYT[jjjj] = paillier.Encryption(RR2);
                   CCCC = CCCC .add(BigInteger.valueOf(   QUERYT[jjjj].T1 .bitLength()+  QUERYT[jjjj].T2 .bitLength()));
      ...
      //                     SEC  SK1 = new SEC (EVBA[k][jjjj],QUERYT[jjjj] ,paillier);
      //                           SK1.StepOne();
      //                           SK1.StepTwo1();
       //                          SK1.StepTwoA();
       //                          SK1.StepTwoB();
